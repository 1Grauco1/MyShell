...
PopupWindow {
    ...
    property var g_antData: ({exists: false, updates: 0, commits: []})
    ...
    Rectangle {
        ...
        ColumnLayout {
            ...
            ColumnLayout {
                ...
                RepoSection { title: "G_ant (Configs)"; repoData: g_antData; icon: "󱂵" }
                Rectangle { Layout.fillWidth: true; height: 1; color: Theme.glassBorder }
                RepoSection { title: "G_ant Shell"; repoData: shellData; icon: "󰚰" }
            }
        ...
        stdout: StdioCollector {
            onStreamFinished: {
                try {
                    ...
                    g_antData = data.g_ant || {exists: false, updates: 0, commits: []};
                    shellData = data.g_ant_shell || {exists: false, updates: 0, commits: []};
                } catch (e) {
                }
            }
        }
