...
PanelWindow {
    ...
    // Screen-relative x of the media widget's center (bar window origin + its left margin),
    // used by the hover player popup to align itself under the widget.
    property real mediaHoverX: centerSide.mediaHoverX + Theme.barMarginLeft
    ...
    Rectangle {
        ...
        RowLayout {
            ...
            Network { 
                id: wifiWidget 
                visible: WidgetSettings.enableNetwork
            }
